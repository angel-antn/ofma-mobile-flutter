...
class ContentMusiciansList extends StatelessWidget {
  const ContentMusiciansList({
    super.key,
    required this.musicians,
  });

  final List<ExclusiveContentMusician?> musicians;
...
class _ConcertMusicianCard extends StatelessWidget {
  ...
  final ExclusiveContentMusician? musician;
