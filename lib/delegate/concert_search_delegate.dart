...
class ConcertSearchDelegate extends SearchDelegate {
  @override
  String? get searchFieldLabel => 'Buscar concierto';
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: contentRequest.getContent(
          highlighted: false, name: query, category: 'concierto'),
...
class _SuggestionImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      ...
      children: [
        SvgPicture.asset(
          'assets/images/search_image_2.svg',
          width: 300,
        ),
        const SizedBox(
          height: 10,
        ...
        const Text(
          '¿Interesado en ver un concierto?',
        ...
        const Text(
          'busca el nombre y disfrutalo en cualquier momento',
          textAlign: TextAlign.center,
          style: TextStyle(
            color: Colors.black45,
          ),
